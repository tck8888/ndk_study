...
/**
 * <p>description:不需要显示到屏幕上写入fbo (帧缓存)</p>
 * <p>created on: 2019/6/13 8:23</p>
 *
 * @author tck
 * @version 3.5.2
 */
public class CameraFilter extends AbstractFilter{
    ...
    public CameraFilter(Context context, int vertexShaderId, int fragmentShaderId) {
...
//        };
    ...
    public void onReady(int width, int height) {
        ...
        //创建纹理
        OpenUtils.glGenTextures(mFrameBufferTextures);
