...
import com.tck.HelloOpenGL.util.OpenUtils;
...
public abstract class AbstractFilter {
    ...
    protected void initilize(Context context) {
        String vertexSharder = OpenUtils.readRawTextFile(context, mVertexShaderId);
        String framentShader = OpenUtils.readRawTextFile(context, mFragmentShaderId);
        mGLProgramId = OpenUtils.loadProgram(vertexSharder, framentShader);
